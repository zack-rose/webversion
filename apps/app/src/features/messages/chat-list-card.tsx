...
export const ChatListCard = () => {
	...
	return (
		<Link
			href="/messages/765"
			className="min-w-full flex gap-4 items-center border-b border-3deg-greenish-100 mb-2 last:mb-0 lg:pr-2"
		>
			<div>
			...
			<div className="space-y-1 pb-2">
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-2">
						<h5 className="font-medium text-3deg-black-300">Tom Cruise</h5>
						<p
				...
				<div className="flex justify-between items-end gap-10">
					<p className="line-clamp-2 text-[0.8125rem] text-3deg-choco-650">
